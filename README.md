# Rust API client for space-traders
...
Put the package under your project folder in a directory named `space-traders` and add the following to `Cargo.toml` under `[dependencies]`:

```
space-traders = { path = "./space-traders" }
```
