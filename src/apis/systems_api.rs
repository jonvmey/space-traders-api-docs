...
pub async fn get_system_waypoints(configuration: &configuration::Configuration, system_symbol: &str, page: Option<u32>, limit: Option<u8>, r#type: Option<models::WaypointType>, traits: Option<models::GetSystemWaypointsTraitsParameter>) -> Result<models::GetSystemWaypoints200Response, Error<GetSystemWaypointsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_systems(configuration: &configuration::Configuration, page: Option<u32>, limit: Option<u8>) -> Result<models::GetSystems200Response, Error<GetSystemsError>> {
    let local_var_configuration = configuration;
