...
pub async fn get_contracts(configuration: &configuration::Configuration, page: Option<u32>, limit: Option<u8>) -> Result<models::GetContracts200Response, Error<GetContractsError>> {
    let local_var_configuration = configuration;
