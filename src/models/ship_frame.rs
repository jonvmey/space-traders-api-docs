...
impl ShipFrame {
    ...
    pub fn new(symbol: Symbol, name: String, description: String, condition: f64, integrity: f64, module_slots: u32, mounting_points: u32, fuel_capacity: u32, requirements: models::ShipRequirements) -> ShipFrame {
        ShipFrame {
            symbol,
            name,
            description,
